...
namespace CoffeeHouse.DataBase
{
    ...
    public partial class Entities3 : DbContext
    {
        ...
        [DbFunction("Entities3", "UDF_GetLevelGuest")]
        public virtual IQueryable<UDF_GetLevelGuest_Result> UDF_GetLevelGuest(Nullable<int> lvl)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<UDF_GetLevelGuest_Result>("[Entities3].[UDF_GetLevelGuest](@Lvl)", lvlParameter);
        }
    
        [DbFunction("Entities3", "UDF_SupplyDate")]
        public virtual IQueryable<UDF_SupplyDate_Result> UDF_SupplyDate(Nullable<System.DateTime> sDate, Nullable<System.DateTime> eDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<UDF_SupplyDate_Result>("[Entities3].[UDF_SupplyDate](@sDate, @eDate)", sDateParameter, eDateParameter);
        }
